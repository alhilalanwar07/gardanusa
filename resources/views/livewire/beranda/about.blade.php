                ...
                <div class="col-xl-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="image-wrapper">
                        <div class="images position-relative" data-aos="zoom-out" data-aos-delay="400">
                            <img src="{{url('/')}}/assets-front/img/about-5.webp" alt="Business Meeting" class="img-fluid main-image rounded-4">
                            <img src="{{url('/')}}/assets-front/img/about-2.webp" alt="Team Discussion" class="img-fluid small-image rounded-4">
                        </div>
